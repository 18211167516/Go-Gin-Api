...
var menu = []models.SysMenu{
	...
	{Model: models.Model{ID: 28, CreatedAt: models.XTime{time.Now()}, UpdatedAt: models.XTime{time.Now()}}, Name: "权限管理", Path: "/admin/ruleRbacViwe/:id", ParentId: 29, Hidden: &astring, Sort: 0, Is_view: "0"},
	...
	{Model: models.Model{ID: 35, CreatedAt: models.XTime{time.Now()}, UpdatedAt: models.XTime{time.Now()}}, Name: "设置角色权限", Path: "/admin/updateRbac", ParentId: 28, Hidden: &astring, Sort: 0, Is_view: "0"},
	...
	{Model: models.Model{ID: 45, CreatedAt: models.XTime{time.Now()}, UpdatedAt: models.XTime{time.Now()}}, Name: "重置个人密码", Path: "/admin/updateUser/:id", ParentId: 33, Hidden: &astring, Sort: 0, Is_view: "0"},
...
func InitSysMenus(db *gorm.DB) {
	if err := db.Transaction(func(tx *gorm.DB) error {
		if tx.Where("id IN ?", []int{22, 29}).Find(&[]models.SysMenu{}).RowsAffected == 2 {
